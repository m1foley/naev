...
title[5] = "You did it!"
text[5] = [[After disabling the ship you take your small crew along with you and go in ready for a fight! But when you get on the small Koala you find only two men guarding it, and it turns out they are not prepared for fighting at all. They can pilot a ship, but fighting is not their forte. While your crew ties them up, you enter the cargo hold to rescue the children. When you get there, you discover there are more than just the three; there are around a couple dozen! This is all probably just the tip of the iceberg, too. Either way, it's time to head back to %s and reunite the parents with their children.]]

title[6] = "Reunited"
text[6] = [[As soon as you step off the landing deck with a following of a couple dozen children, the two parents you've spoken with come running. From behind you hear children yelling, "Mom! Dad!" Three children shove their way out from the other kids and the parents and children meet in a big group of hugs, kisses, tears, and smiles from ear to ear.
You and the children stand off to the side and watch one of the most beautiful reunions you have seen. After a little while the father approaches you, wiping a tear from his cheek. He stands in front of you for a moment, then suddenly takes you in an embrace. Releasing you he says, "Thank you so much %s, you have no idea how much this means to my family. I would love to be able to repay you somehow, but I just have no idea how I can do so right now. You have rescued my children, and brought them back to me. Thank you isn't enough, but I'm afraid for now it's the best I can do. If there is anything I can ever do for you, feel free to ask me, my friend."
]]
...
declinetext = [[You can hear that the the man is quite disappointed as he says, "I'm sure you have good reasons to not want to help, perhaps you have something else more pressing..." Before the comm is cut you can hear the woman beginning to sob and the man consoling her.]]

failedtitle = "You killed the children"
failedtext = [[Having just destroyed the kidnappers, you also just killed the children as well. As you sit there in space, with your head against the dash, you think of the parents and their children who are forever stolen from them. If only you could rewind and try again; you know the next time you would be more cautious. If only it were so easy...]]
